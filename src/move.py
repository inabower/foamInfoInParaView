...
renderView1.CameraPosition = [0.1192417304003123, -0.0049446618735349245, 0.5552076555508942]
renderView1.CameraFocalPoint = [0.1192417304003123, -0.0049446618735349245, 0.004999999776482582]
...
initialCameraPosition = np.array([0.02,0,0.5])
initialCameraFocalPoint = np.array([0.02,0,0.05])
renderView1.CameraViewUp = [1.0, 0, 0.0]

N = 2
XY = 0.18
arrN2 = np.power(np.arange(0.0,1.0,0.05),N)

xmove = np.zeros(30)
ymove = np.zeros_like(xmove)
xmove2 = np.array([a*XY/2 for a in arrN2])
ymove2 = np.zeros_like(xmove2)
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

xmove2 = np.array([XY-(a*XY/2) for a in reversed(arrN2)])
ymove2 = np.zeros_like(xmove2)
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)
...
ymove2 = np.zeros(30)
xmove2 = np.array([XY for i in ymove2])
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

ymove2 = np.array([a*XY/2 for a in arrN2])
xmove2 = np.array([XY for i in ymove2])
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

ymove2 = np.array([XY-(a*XY/2) for a in reversed(arrN2)])
xmove2 = np.array([XY for i in ymove2])
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

ymove2 = np.array([XY-a*XY for a in arrN2])
xmove2 = np.array([XY for i in ymove2])
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

ymove2 = np.array([-XY+(a*XY) for a in reversed(arrN2)])
xmove2 = np.array([XY for i in ymove2])
xmove = np.append(xmove,xmove2);ymove = np.append(ymove,ymove2)

t = -1
for n in range(len(xmove)):
	if n%1==0:
		t += 1
		if t > len(times)-1:
			t = 0
	...
	renderView1.CameraPosition = initialCameraPosition + np.array([xmove[n], ymove[n], 0])
	renderView1.CameraFocalPoint = initialCameraFocalPoint + np.array([xmove[n], ymove[n], 0])
...
cmd = 'convert -loop 0 -delay 10 {}/{}*.png {}/{}.gif'.format(pngDir,figName,picDir,figName)
